...
@section('login')
  <h1 class="text-center">@if(isset($fornecedor))Editar @else Cadastrar @endif</h1>
  ...
  @endif
    @csrf
      ...
      <div class="form-group">
        ...
        <textarea type="password" class="form-control" id="confirmasSenha" name="confirmasSenha" rows="3" required>{{$fornecedor->confirmaSenha ?? ''}}</textarea>
      </div>
